...
export default function FarmerLimitConfiguration() {
  // Form State
  ...
  const handleEdit = (item: FarmerLimit) => {
    setFormData({
      state: item.state,
  ...
  const handleDelete = (id: string) => {
    if (confirm('Are you sure you want to delete this farmer limit configuration?')) {
  ...
  return (
    <div className="p-8 pb-20" style={{ backgroundColor: '#FFFFFF', minHeight: '100vh' }}>
      ...
      <div className="mb-6 flex items-center gap-2" style={{ fontSize: '14px', color: '#666' }}>
        ...
        <span style={{ fontWeight: '600', color: '#222' }}>Farmer Limit Configuration</span>
      </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p style={{ fontSize: '13px', color: '#666', marginTop: '2px' }}>
                {filteredData.length} of {farmerLimits.length} configurations
              </p>
            </div>
          </div>
                ...
                <tr>
                  <td colSpan={6} className="px-6 py-16 text-center" style={{ color: '#315B78' }}>
                    ...
                    <p style={{ fontSize: '14px', color: '#666' }}>
                      {searchQuery || activeFilterCount > 0 ? 'Try adjusting your search or filters' : 'Click "Add Configuration" to create a new farmer limit configuration'}
                    </p>
                  </td>
                </tr>
              )}
            ...
            <div className="sticky top-0 z-10 px-8 py-6 border-b flex items-center justify-between" style={{ backgroundColor: '#FFFFFF', borderColor: '#E5EBEF' }}>
              <div>
                <h2 style={{ fontSize: '22px', fontWeight: '700', color: '#003A5D', marginBottom: '4px' }}>
                  {editingId ? 'Edit Farmer Limit' : 'Add Farmer Limit'}
                </h2>
                <p style={{ fontSize: '14px', color: '#666' }}>
                  Configure farmer procurement limits
                </p>
              </div>
              <button
                onClick={handleCloseDrawer}
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      required
                      value={formData.perAcreLimit}
                      onChange={(e) => setFormData({ ...formData, perAcreLimit: e.target.value })}
